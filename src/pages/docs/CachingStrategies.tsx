        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">Why Cache AI Responses?</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">Built-in Caching</h2>
                <p className="text-white/70 mb-4">
...
{`const orchesity = new Orchesity({
  cache: {
    ...
    storage: "memory" // "memory", "redis", or "custom"
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">Advanced Caching Techniques</h2>
                <div className="grid gap-4">
                  <div className="p-4 rounded-lg border border-white/10 bg-black/40">
                    <h3 className="font-medium text-white mb-2">Semantic Caching</h3>
                    <p className="text-white/70">
                      Use vector embeddings to cache semantically similar queries, not just exact matches.
                    </p>
                  </div>
                  <div className="p-4 rounded-lg border border-white/10 bg-black/40">
                    <h3 className="font-medium text-white mb-2">Distributed Caching</h3>
                    <p className="text-white/70">
                      Set up Redis or other distributed caching solutions for multi-server deployments.
                    </p>
                  </div>
                  <div className="p-4 rounded-lg border border-white/10 bg-black/40">
                    <h3 className="font-medium text-white mb-2">Selective Caching</h3>
                    <p className="text-white/70">
