          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="prose prose-invert max-w-4xl mx-auto">
              <div className="space-y-6">
                <section id="introduction" className="glass-card p-6 rounded-lg">
                ...
                <section id="information" className="glass-card p-6 rounded-lg">
                ...
                <section id="usage" className="glass-card p-6 rounded-lg">
                ...
                <section id="rights" className="glass-card p-6 rounded-lg">
                ...
                <section id="contact" className="glass-card p-6 rounded-lg">
