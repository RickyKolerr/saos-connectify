        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-4 opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-saos-navy">
            ...
            <div className="flex flex-col sm:flex-row gap-2 min-[400px]:gap-4">
              <Button className="bg-saos-blue hover:bg-saos-navy text-white">
                Get Started Now
            ...
            <div className="flex items-center space-x-4 text-sm">
              ...
              <div className="flex items-center">
                <div className="h-4 w-4 rounded-full bg-green-500 mr-2"></div>
                <span className="text-gray-500">Free for 14 days</span>
              </div>
            </div>
          </div>
          <div className="mx-auto lg:mr-0 opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <div className="relative p-2">
              <div className="w-full h-full bg-gradient-to-r from-saos-navy via-saos-blue to-saos-teal opacity-30 blur-xl absolute inset-0 rounded-xl"></div>
              <div className="relative rounded-xl overflow-hidden border shadow-xl animate-float">
                <svg
                ...
                >
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <circle cx="100" cy="120" r="20" fill="#172B4D" />
                  <circle cx="100" cy="280" r="20" fill="#172B4D" />
                  <circle cx="500" cy="120" r="20" fill="#36B37E" />
                  <circle cx="500" cy="280" r="20" fill="#36B37E" />
