...
const HeroSection = () => {
  return (
    <section className="py-20 md:py-28 overflow-hidden bg-gradient-to-b from-background via-background/95 to-secondary/90 relative">
      ...
      <div className="absolute top-0 right-0 w-[40rem] h-[40rem] rounded-full bg-white/2 blur-[100px]"></div>
      <div className="absolute bottom-0 left-0 w-[30rem] h-[30rem] rounded-full bg-white/2 blur-[100px]"></div>
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-4 opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="inline-flex items-center self-start gap-2 rounded-full bg-white/5 px-4 py-1.5 text-sm text-white/70 mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2 min-[400px]:gap-4 pt-2">
              ...
              <Button variant="outline" className="border-white/30 text-foreground hover:bg-white/5 hover:border-white/50 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300">
                Request Demo
              </Button>
            </div>
          ...
          <div className="mx-auto lg:mr-0 opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <div className="relative p-2">
              ...
              <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/10 z-0 animate-[spin_20s_linear_infinite]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-white/30 shadow-[0_0_10px_2px_rgba(255,255,255,0.2)]"></div>
              </div>
              <div className="absolute top-1/2 left-1/2 w-[250px] h-[250px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/10 z-0 animate-[spin_15s_linear_infinite_reverse]">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-white/30 shadow-[0_0_10px_2px_rgba(255,255,255,0.2)]"></div>
              </div>
            </div>
          </div>
        </div>
