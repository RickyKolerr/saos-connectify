    ...
    <section className="py-16 bg-white">
      <div className="container px-4 md:px-6">
        <div className="max-w-4xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
          <div className="relative rounded-xl overflow-hidden bg-gradient-to-r from-saos-navy to-saos-blue p-1">
            <div className="absolute top-0 left-0 w-full h-full opacity-10">
              <div className="w-24 h-24 rounded-full bg-white absolute -top-12 -left-12"></div>
              <div className="w-16 h-16 rounded-full bg-white absolute top-20 right-20"></div>
              <div className="w-20 h-20 rounded-full bg-white absolute bottom-8 left-1/4"></div>
            </div>
            
            <div className="bg-white rounded-lg p-8 md:p-12 relative">
              <Quote className="h-12 w-12 text-saos-blue/20 absolute top-6 left-6" />
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="text-center md:text-left">
                  <blockquote className="text-lg md:text-xl mb-4 font-medium text-gray-700">
                  ...
                  <footer>
                    <div className="font-semibold text-saos-navy">Sarah Chen</div>
