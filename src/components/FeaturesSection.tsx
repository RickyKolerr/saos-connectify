...
const Feature = ({ icon, title, description, delay }: FeatureProps) => (
  <div className="group flex flex-col items-center text-center p-4 md:p-6 rounded-xl glass-card opacity-0 animate-fade-in transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_rgba(0,0,0,0.1)]" style={{ animationDelay: delay }}>
    <div className="p-3 rounded-full bg-black/10 text-black mb-4 group-hover:bg-black/20 group-hover:text-black transition-all duration-300 transform group-hover:scale-110">
      {icon}
    </div>
    ...
    <section id="features" className="py-16 bg-background">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          <div className="inline-block rounded-lg bg-black/10 px-3 py-1 text-sm text-black/70">
            Key Features
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <Feature
            ...
            delay="0.5s"
          />
          <div className="p-6 rounded-xl border border-dashed border-border glass-card flex flex-col items-center justify-center text-center opacity-0 animate-fade-in hover:border-black/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.1)] transition-all duration-300 transform hover:scale-105" style={{ animationDelay: "0.6s" }}>
            <h3 className="text-xl font-semibold mb-2 text-black/70">And Many More...</h3>
